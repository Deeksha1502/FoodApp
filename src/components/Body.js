  ...
  return (
    <div>
      <div className="flex mt-4 font-Metrophobic">
        ...
        <div className="my-4 px-40 ml-96 flex justify-end">
          <input
            type="text"
            className="py-1 ml-2 border-2 border-blue bg-white h-10 px-5 pr-16 rounded-l-full text-sm focus:shadow-outline"
            value={searchText}
            onChange={(e) => setSearchText(e.target.value)}
          ></input>

          <button
            className="py-1 border-2 font-Metrophobic h-10 px-5 rounded-r-full focus:shadow-outline  text-lg"
            onClick={filterList}
          >
            Search
          </button>
